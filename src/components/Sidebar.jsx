            ...
            <div className={`sidebar-menu ${isOpen ? 'active' : ''}`} id="sidebarMenu">
                ...
                <div className="sidebar-content">
                    <ul className="sidebar-nav">
                        ...
                        <li className="sidebar-item">
                            <a href="#/products" className="sidebar-link" onClick={onClose}>
                                <span className="link-icon"><i className="fas fa-box"></i></span>
                ...
                <div className="sidebar-footer">
                    <div className="sidebar-social">
                        ...
                        <a href="https://www.instagram.com/aadyaainfotech" target="_blank" rel="noopener noreferrer" className="social-icon"><i className="fab fa-instagram"></i></a>
